...
function Footer() {
  ...
  return (
    <div className="footer">
      <div className="custom-shape-divider-top-1753560446">
        <svg
          data-name="Layer 1"
      ...
      <div className="footer-container">
        ...
        <div className="links-resources">
          <div className="resources">
            ...
            <hr />
            <ul>
              <li className="hoverEffect">Instructions</li>
              <li className="hoverEffect">Personal Meeting</li>
              <li className="hoverEffect">Doctor List</li>
              <li className="hoverEffect">Refund Policy</li>
            </ul>
          </div>
          <div className="links">
            <h4>Links</h4>
      ...
      <div className="policy">
        <div>
          <span> Copyright &copy; 2025</span> Aman AlHayah
        </div>
        <ul>
